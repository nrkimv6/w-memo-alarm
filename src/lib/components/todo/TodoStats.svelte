<script lang="ts">
	...
	import { getTodoStatsSummary, type TodoStatsSummary } from '$lib/utils/todoStats';
	import { getTodayProgress, getWeekProgress, getMonthProgress } from '$lib/utils/todoProgress';
	import { TrendingUp, Flame, Clock, CheckCircle, Circle, SkipForward } from 'lucide-svelte';
	...
	const stats = $derived(() => {
		...
		return getTodoStatsSummary(todos, todayProgress, weekProgress, monthProgress);
	});
...
<div class="space-y-4">
	<!-- 헤더 -->
	<div class="flex items-center gap-2 pb-2 border-b dark:border-gray-700">
	...
	<div class="grid grid-cols-3 gap-3">
		...
		<div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-3">
			<div class="text-xs text-purple-700 dark:text-purple-300 font-medium mb-1">
				이번 주
			</div>
		...
		<div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
			<div class="text-xs text-green-700 dark:text-green-300 font-medium mb-1">
				이번 달
			</div>
	...
	<div class="grid grid-cols-4 gap-2">
		<div class="bg-gray-50 dark:bg-gray-800 border dark:border-gray-700 rounded-lg p-3 text-center">
		...
		<div class="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-3 text-center">
			<div class="flex items-center justify-center mb-1">
