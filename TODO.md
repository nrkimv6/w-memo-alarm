...
- [ ] **foreground 경로 동일 시간대 알림 병합 누락 수정** — [plan](docs/plan/2026-04-24_fix-notification-merge-in-foreground.md) (0/18, 0%)
- [ ] **브라우저 cold load 설정 토글 상태 디싱크 수정** — [plan](docs/plan/2026-04-24_fix-settings-state-desync-on-cold-load.md) (0/16, 0%)
