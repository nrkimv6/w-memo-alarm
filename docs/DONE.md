...
- [x] 2026-05-10: 고정/즐겨찾기 할일 카드 렌더링 수정 — 대시보드 북마크 섹션에서 할일 항목을 `TodoCard`로 표시해 메모 전환 후 복제처럼 보이는 문제 해소 — [archive](archive/2026-05-10_fix-pinned-todo-dashboard-rendering.md)
