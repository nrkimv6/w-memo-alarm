...
| # | 항목 | 관련 PRD |
|---|------|---------|
| 1 | **기존 memoType 'task' 데이터 존재 여부**: 마이그레이션 필요? | PRD 4.1 |

### Phase 3 시작 전 결정

| # | 항목 | 관련 PRD |
|---|------|---------|
| 2 | **overdue 반복할일의 자동 건너뛰기 여부**: 기한 N일 경과 시 자동 skip? | PRD 3.4 |
| 3 | **todoInstances 비대화 방지 전략**: 오래된 인스턴스 아카이브 기준 | PRD 4.3 |
| 4 | **상기 알림에 미래 인스턴스 포함 여부**: 아직 미생성된 반복 일정도 카운트? | - |
